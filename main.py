...
def optimizar_por_zona(ciudad="Tlaxcala de Xicohténcatl, Tlaxcala, Mexico", hora_pico=False):
...
def visualizar_semaforos(G, ubicaciones_optimas, output_path="map_high_res.png"):
...
if __name__ == "__main__":
    resultados = optimizar_por_zona("San Francisco, USA", hora_pico=True)
    ...
    G_sf = ox.graph_from_place("San Francisco, USA", network_type="drive")
